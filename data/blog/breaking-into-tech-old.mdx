---
title: Tips for Breaking into the Tech Industry (Old)
date: '2017-12-28'
tags: ['advice', 'career', 'archive']
draft: false
summary: 'It took me a long time to find a job, so I thought I would share my most useful advice on the matter. It iss an uphill battle, but once you get the first one, the rest are easy.'
images: []
layout: PostLayout
type: Blog
---
...
I recently got my first developer job as an Internal Technical Support Engineer at a company called [Modern Message](http://modernmsg.com) and I want to share a few tips on things I did to help me eventually land this job.
